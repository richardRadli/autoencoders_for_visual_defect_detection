...
from utils.utils import create_timestamp, use_gpu_if_available, setup_logger, create_save_dirs, get_loss_function, \
    visualize_images
...
class TrainDenoisingAutoEncoder:
    def __init__(self):
        ...
        if self.train_cfg.network_type not in ["DAE", "DAEE"]:
